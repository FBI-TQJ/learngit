...
using TQJProject.Sessions;
using TQJProject.Web.Controllers.Results;
using TQJProject.Web.Models;
using TQJProject.Web.Models.Account;
...
{
    public class AccountController : TQJProjectControllerBase
    {
